 ...
 * 
 */
public final class Hive_UDAF_Commision extends UDAF {
  ...
  public static class UDAFExampleAvgEvaluator implements UDAFEvaluator {
    ...
    public UDAFAvgState terminatePartial() {
      ...
      return state.mSum == 0 ? null : state;
    }
    ...
    public Double terminate() {
      // This is SQL standard - average of zero items should be null.
      return state.mSum == 0 ? null : Double.valueOf(state.mSum
          );
    }
  }

  private Hive_UDAF_Commision() {
